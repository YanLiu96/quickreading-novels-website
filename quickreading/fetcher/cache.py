...
from quickreading.fetcher.decorators import cached
from quickreading.fetcher.function import target_fetch, get_time, get_html_by_requests, get_random_user_agent
from quickreading.fetcher.extract_novels import extract_pre_next_chapter
                ...
                if netloc in LATEST_RULES.keys():
                    ...
                    if latest_chapter_name and latest_chapter_url:
                        ...
                        data = {
                            ...
                            "quickreading_content_url": "/quickreading_content?url={latest_chapter_url}&name={name}&chapter_url={chapter_url}&novels_name={novels_name}".format(
                                latest_chapter_url=latest_chapter_url,
