...
from src.fetcher.function import target_fetch, get_time, get_html_by_requests, get_random_user_agent
from src.fetcher.extract_novels import extract_pre_next_chapter
from src.config import RULES, LATEST_RULES, LOGGER
